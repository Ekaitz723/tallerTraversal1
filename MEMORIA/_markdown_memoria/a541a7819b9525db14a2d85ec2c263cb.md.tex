...
\markdownRendererHeadingTwo{Análisis de Rendimiento y Memoria Usando Valgrind}\markdownRendererInterblockSeparator
...
{}\markdownRendererSectionBegin
\markdownRendererHeadingThree{Análisis de Memoria (Memcheck)}\markdownRendererInterblockSeparator
{}\markdownRendererSectionBegin
\markdownRendererHeadingFour{Estado General del Programa Principal}\markdownRendererInterblockSeparator
...
\markdownRendererHeadingFour{Detalles del Heap - Main}\markdownRendererInterblockSeparator
...
{}
\markdownRendererSectionEnd \markdownRendererSectionBegin
\markdownRendererHeadingFour{Desglose de Memory Leaks}\markdownRendererInterblockSeparator
{}\markdownRendererUlBeginTight
...
{}
\markdownRendererSectionEnd \markdownRendererSectionBegin
\markdownRendererHeadingFour{Estado de Tests Unitarios}\markdownRendererInterblockSeparator
{}\markdownRendererUlBeginTight
...
\markdownRendererSectionEnd \markdownRendererSectionBegin
\markdownRendererHeadingThree{Análisis de Rendimiento (Callgrind/Cachegrind)}\markdownRendererInterblockSeparator
{}\markdownRendererSectionBegin
\markdownRendererHeadingFour{Observaciones de Rendimiento}\markdownRendererInterblockSeparator
{}\markdownRendererUlBeginTight
...
\markdownRendererSectionEnd 
\markdownRendererSectionEnd \markdownRendererSectionBegin
\markdownRendererHeadingThree{Ubicación Específica del Memory Leak}\markdownRendererInterblockSeparator
...
{}
\markdownRendererSectionEnd \markdownRendererSectionBegin
\markdownRendererHeadingThree{Interpretación Técnica}\markdownRendererInterblockSeparator
{}\markdownRendererSectionBegin
\markdownRendererHeadingFour{Impacto del Memory Leak}\markdownRendererInterblockSeparator
{}\markdownRendererUlBeginTight
...
{}
\markdownRendererSectionEnd \markdownRendererSectionBegin
\markdownRendererHeadingFour{Calidad del Código}\markdownRendererInterblockSeparator
{}\markdownRendererUlBeginTight
