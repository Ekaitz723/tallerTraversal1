...
\markdownRendererUlItem \markdownRendererStrongEmphasis{Acción tomada}: Se ha decidido ignorar temporalmente este issue debido a que \markdownRendererCodeSpan{v2} se utiliza como "puntero recipiente" con llamadas a \markdownRendererCodeSpan{free()} controladas en los test.\markdownRendererUlItemEnd 
